      ...
      case cm: CreateModel =>
        ...
        val juba: ScFuture[JubatusYarnApplication] = runMode match {
          case RunMode.Production(zookeeper) =>
            ...
            val jubaClusterConfig = JubatusClusterConfiguration(cm.modelName, jubaType, location, configJsonStr, None, resource, 2, applicationName, serverConfig, proxyConfig, logConfig)
