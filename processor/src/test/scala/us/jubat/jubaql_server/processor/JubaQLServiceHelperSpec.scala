...
import us.jubat.yarn.common.{LearningMachineType, ServerConfig, ProxyConfig, Mixer}
...
class JubaQLServiceHelperSpec extends FlatSpec with ShouldMatchers with BeforeAndAfterAll {
  ...
  "getModelsStatus()" should "success models status" taggedAs (LocalTest) in {
    ...
    // モデル1件(resourceConfig/serverConfig/proxyConfigなし)
    val cm = new CreateModel("CLASSIFIER", "test", None, null, "config", None, None, None)
    ...
    // モデル2件(resourceConfig/serverConfig/proxyConfigあり)
    val cm2 = new CreateModel("CLASSIFIER", "test2", None, null, "config",
      Option("resourceConfig"), Option("serverConfig"), Option("proxyConfig"))
  ...
  it should "error server config for thread" taggedAs (LocalTest) in {
    ...
    // 範囲外
    serverConfig = s"""{"thread": ${Int.MaxValue + 1}}""".stripMargin.trim
    result = service.complementServerConfig(Option(serverConfig))
    result match {
      case Right(value) =>
        fail()
  ...
  it should "error server config for timeout" taggedAs (LocalTest) in {
    ...
    // 範囲外
    serverConfig = s"""{"timeout": ${Int.MaxValue + 1}}""".stripMargin.trim
    result = service.complementServerConfig(Option(serverConfig))
    result match {
      case Right(value) =>
        fail()
  ...
  it should "error server config for interval_sec" taggedAs (LocalTest) in {
    ...
    // 範囲外
    serverConfig = s"""{"interval_sec": ${Int.MaxValue + 1}}""".stripMargin.trim
    result = service.complementServerConfig(Option(serverConfig))
    result match {
      case Right(value) =>
        fail()
  ...
  it should "error server config for interval_count" taggedAs (LocalTest) in {
    ...
    // 範囲外
    serverConfig = s"""{"interval_count": ${Int.MaxValue + 1}}""".stripMargin.trim
    result = service.complementServerConfig(Option(serverConfig))
    result match {
      case Right(value) =>
        fail()
  ...
  it should "error server config for zookeeper_timeout" taggedAs (LocalTest) in {
    ...
    // 範囲外
    serverConfig = s"""{"zookeeper_timeout": ${Int.MaxValue + 1}}""".stripMargin.trim
    result = service.complementServerConfig(Option(serverConfig))
    result match {
      case Right(value) =>
        fail()
  ...
  it should "error server config for interconnect_timeout" taggedAs (LocalTest) in {
    ...
    // 範囲外
    serverConfig = s"""{"interconnect_timeout": ${Int.MaxValue + 1}}""".stripMargin.trim
    result = service.complementServerConfig(Option(serverConfig))
    result match {
      case Right(value) =>
        fail()
  ...
  it should "error proxy config for thread" taggedAs (LocalTest) in {
    ...
    // 範囲外
    proxyConfig = s"""{"thread": ${Int.MaxValue + 1}}""".stripMargin.trim
    result = service.complementProxyConfig(Option(proxyConfig))
    result match {
      case Right(value) =>
        fail()
  ...
  it should "error proxy config for timeout" taggedAs (LocalTest) in {
    ...
    // 範囲外
    proxyConfig = s"""{"timeout": ${Int.MaxValue + 1}}""".stripMargin.trim
    result = service.complementProxyConfig(Option(proxyConfig))
    result match {
      case Right(value) =>
        fail()
  ...
  it should "error proxy config for zookeeper_timeout" taggedAs (LocalTest) in {
    ...
    // 範囲外
    proxyConfig = s"""{"zookeeper_timeout": ${Int.MaxValue + 1}}""".stripMargin.trim
    result = service.complementProxyConfig(Option(proxyConfig))
    result match {
      case Right(value) =>
        fail()
  ...
  it should "error proxy config for interconnect_timeout" taggedAs (LocalTest) in {
    ...
    // 範囲外
    proxyConfig = s"""{"interconnect_timeout": ${Int.MaxValue + 1}}""".stripMargin.trim
    result = service.complementProxyConfig(Option(proxyConfig))
    result match {
      case Right(value) =>
        fail()
  ...
  it should "error proxy config for pool_expire" taggedAs (LocalTest) in {
    ...
    // 範囲外
    proxyConfig = s"""{"pool_expire": ${Int.MaxValue + 1}}""".stripMargin.trim
    result = service.complementProxyConfig(Option(proxyConfig))
    result match {
      case Right(value) =>
        fail()
  ...
  it should "error proxy config for pool_size" taggedAs (LocalTest) in {
    ...
    // 範囲外
    proxyConfig = s"""{"pool_size": ${Int.MaxValue + 1}}""".stripMargin.trim
    result = service.complementProxyConfig(Option(proxyConfig))
    result match {
      case Right(value) =>
        fail()
  ...
  "takeAction():CreateModel" should "return an success for Development mode" taggedAs (LocalTest) in {
    ...
    result match {
      case Right(value) =>
        val sp = value.asInstanceOf[StatementProcessed]
        sp.result shouldBe "CREATE MODEL (started) (proxy setting has been ignored in Development mode)"
        service.startedJubatusInstances.get("test1") match {
          case Some((jubaFut, _, _)) =>
            Await.ready(jubaFut, Duration.Inf)
            jubaFut.value match {
  ...
  it should "error model and method mismatch for Anomaly" taggedAs (LocalTest) in {
    val cm = new CreateModel("ANOMALY", "test", None, List(), "")
    val juba = new LocalJubatusApplicationTester("test")
  ...
  it should "error model and method mismatch for Classifier" taggedAs (LocalTest) in {
    val cm = new CreateModel("CLASSIFIER", "test", None, List(), "")
    val juba = new LocalJubatusApplicationTester("test")
  ...
  it should "error model and method mismatch for Recommender" taggedAs (LocalTest) in {
    val cm = new CreateModel("RECOMMENDER", "test", None, List(), "")
    val juba = new LocalJubatusApplicationTester("test")
  ...
  it should "error no 'label' in learningData for Classifier" taggedAs (LocalTest) in {
    val cm = new CreateModel("CLASSIFIER", "test", Some(("label", "label")), List(), "")
    val juba = new LocalJubatusApplicationTester("test")
  ...
  it should "error no 'id' in learningData for Recommender" taggedAs (LocalTest) in {
    val cm = new CreateModel("RECOMMENDER", "test", Some(("id", "pname")), List(), "")
    val juba = new LocalJubatusApplicationTester("test")
